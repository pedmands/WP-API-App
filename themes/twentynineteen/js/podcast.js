...
document.querySelector('.load-podcast a').setAttribute( 'href', 'javascript:void(0)');
...
const GetPodcast = () => {
	...
	podcastTrigger.addEventListener( 'click', () => {
           ...
           document.querySelector('.podcast-load-button').style.display="none";
		let queryURL = `${restURL}podcast/${podcastTrigger.getAttribute( 'data-id' )}?_embed`;
		fetch( queryURL )
